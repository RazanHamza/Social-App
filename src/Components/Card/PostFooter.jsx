...
const PostFooter = ({length,id }) => {
    return (
        <>
             <div className="w-full h-8 flex items-center  border-t border-divider pt-4 px-3 my-3">
      ...
      <div className="w-full flex justify-between">
        ...
        <p className="ml-3 text-gray-500"><Link to={'post-details/'+id}>{length} Comment</Link></p>
      </div>
    </div>
